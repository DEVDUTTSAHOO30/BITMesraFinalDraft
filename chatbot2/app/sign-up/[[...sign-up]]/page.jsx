      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-black flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md mx-auto px-6">
          <div className={`mb-10 transition-all duration-1000 ${
            ...
            <p className="text-gray-400 text-base sm:text-lg font-medium">Creating your secure account</p>
          </div>
          ...
          <div className={`mb-10 transition-all duration-1000 delay-400 ${
            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
              {["Preparing Registration", "Securing Account Setup", "Finalizing Profile"].map((step, i) => (
          ...
          <div className={`transition-all duration-1000 delay-800 ${
            ...
            <div className="bg-gray-900/50 rounded-2xl p-4 sm:p-6 border border-gray-800 backdrop-blur-sm">
              <p className="text-white text-base sm:text-lg mb-4 font-medium">
                {animationStep === 1 && "Setting up registration portal..."}
                {animationStep === 2 && "Configuring security parameters..."}
                {animationStep === 3 && "Preparing account creation..."}
                {animationStep >= 4 && "Ready to sign up! Welcome..."}
              </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6">
        <div className="w-full max-w-sm sm:max-w-lg">
          ...
          <div className="text-center mb-8 sm:mb-12 animate-fade-in-up">
            ...
            <p className="text-gray-400 text-lg sm:text-xl font-medium">Create your account and start managing expenses smarter</p>
          </div>
                  ...
                  <SignUp
                    ...
                    appearance={{
                      elements: {
                        ...
                        socialButtonsBlockButton: "bg-gray-800/80 border-gray-600 text-white hover:bg-gray-700/80 hover:border-orange-500/50 transition-all duration-300 rounded-none sm:rounded-xl py-3 sm:py-4 font-medium text-sm sm:text-base w-full",
                        ...
                        formFieldInput: "bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500/30 focus:ring-2 sm:focus:ring-4 rounded-none sm:rounded-xl py-3 sm:py-4 px-4 sm:px-6 text-sm sm:text-base transition-all duration-300 w-full",
                        formFieldLabel: "text-gray-200 font-semibold text-sm sm:text-base mb-2 sm:mb-3",
                        formButtonPrimary: "bg-gradient-to-r from-orange-600 via-orange-500 to-orange-400 hover:from-orange-700 hover:via-orange-600 hover:to-orange-500 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-none sm:rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-xl hover:shadow-orange-500/30 text-sm sm:text-base w-full",
                        ...
                        alertClerkError: "text-red-400 bg-red-500/10 border border-red-500/30 rounded-none sm:rounded-xl p-3 sm:p-4 text-sm",
                        formHeaderTitle: "text-white text-lg sm:text-xl lg:text-2xl font-bold",
                        formHeaderSubtitle: "text-gray-300 text-sm sm:text-base",
                        main: "w-full max-w-full rounded-none sm:rounded-xl",
                        ...
                        internal: "w-full max-w-full overflow-hidden rounded-none sm:rounded-xl",
                        identityPreview: "rounded-none sm:rounded-xl",
                        identityPreviewAvatarBox: "rounded-none sm:rounded-xl",
                        alternativeMethods: "rounded-none sm:rounded-xl",
                        alternativeMethodsBlockButton: "rounded-none sm:rounded-xl",
                        otpCodeFieldInput: "bg-gray-800/60 border-gray-600 text-white focus:border-orange-500 focus:ring-orange-500/30 rounded-none sm:rounded-lg text-center",
                        formFieldInputShowPasswordButton: "text-gray-400 hover:text-orange-400 transition-colors duration-300",
                        formFieldHintText: "text-gray-500 text-xs sm:text-sm",
                        formButtonReset: "text-orange-400 hover:text-orange-300 transition-colors duration-300 text-sm",
                      },
                      variables: {
                        borderRadius: "0.5rem",
                        spacingUnit: "1rem"
      ...
      <style jsx>{`
        ...
        @media (max-width: 640px) {
          ...
          /* Force NO rounded corners on all Clerk elements for mobile */
          [data-clerk-element],
          [data-clerk-element] > *,
        ...
        @media (max-width: 480px) {
          ...
          /* Extra small screen overrides - NO rounded corners */
          [data-clerk-element],
          [data-clerk-element] > *,
          [data-clerk-element] input,
          [data-clerk-element] button,
